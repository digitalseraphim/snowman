...
REG(xtmp8,            XTMP8,            32, 0, 8,  "Temporary 8-bit register")
REG(xtmp16,           XTMP16,           32, 0, 16, "Temporary 16-bit register")
REG(xtmp32,           XTMP32,           32, 0, 32, "Temporary 32-bit register")
REG(xtmp64,           XTMP64,           32, 0, 64, "Temporary 64-bit register")
